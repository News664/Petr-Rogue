...
Character art for `mint`. **Status: complete** — all files below already exist.

Petrified and sealed in the depths, revived by a wandering goddess; carries both
the curse and its antidote. Female (lore rule).
